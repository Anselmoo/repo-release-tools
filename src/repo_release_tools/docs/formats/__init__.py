...
from ._shared import _source_reference, _source_url
from .json import render_json
from .richtext import render_rich, render_structured_rich
from .text import render_structured_txt, render_txt
...
__all__ = [
    ...
    "render_md",
    "render_rich",
    "render_structured_rich",
    "render_structured_txt",
    "render_toml",
    "render_txt",
]
...
def inject_md(
    ...
    *,
    ...
    """
    from repo_release_tools.tools.inject import replace_anchored_block  # noqa: PLC0415
...
def render_toml(
    ...
    *,
    ...
    from repo_release_tools.state import (  # noqa: PLC0415
        _dict_to_toml,
        build_lock,
        docs_lock_path,
        hash_content,

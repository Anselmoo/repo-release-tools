...
- [rrt install](/repo-release-tools/commands/install/) — command-level reference for this surface
- [Setup & tooling commands](/repo-release-tools/commands/setup-tooling/) — install, init, skill, agents, hooks
- [rrt skill](/repo-release-tools/commands/skill/) — one of the surfaces this command wraps
"""

...
- **[GitHub Action](github-action.md)** for CI policy checks that mirror the
  local workflow
- **Generated topic docs**:
  [Semantic branches](semantic-branches.md) and [Git magic](git-magic.md) for
...
- [Semantic branches](semantic-branches.md) — generated branch naming model
  and allowed branch types
- [Git magic](git-magic.md) — generated Git helpers and workflow shortcuts
